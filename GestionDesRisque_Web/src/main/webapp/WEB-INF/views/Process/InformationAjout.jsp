                  ...
                  <f:form class="form-horizontal form-label-left" method="post" modelAttribute="information" action="Addinformation" >
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="InfLabel" class="form-control col-md-7 col-xs-12"  name="information" placeholder="Label" required="required" type="text">
                      </div>
                    </div>
                    
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Label">Description Information<span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                     ...
                     <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="InfLabel" class="form-control col-md-7 col-xs-12"  name="proprietaire" placeholder="Description" required="required" type="text">
                      </div>
                    </div>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 styleSelect">
							...
							<select name="activite.activiteId" id="currencySelect"
								...
								<c:forEach items="${activiteList}" var="activite">
