  ...
  <div class="container body">
    ...
    <div class="col-md-6 col-xs-12" style="margin-left: 250">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br>
                  <f:form modelAttribute="admin" action="AddAdmin" class="form-horizontal form-label-left input_mask">

                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      <input type="text" class="form-control has-feedback-left" name="firstName" id="inputSuccess2" placeholder="First Name">
                      <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                    </div>

                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      <input type="text" class="form-control" id="inputSuccess3" name="lastName"  placeholder="Last Name">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                      <input type="text" class="form-control" id="inputSuccess5" name="pwd" placeholder="pwd">
